...
> = {
  ...
  "forensic-audit": {
    title: "Forensic and Fraud Audit",
  ...
  "icfr": {
    ...
    details: [
      ...
      "Prepare Risk Control Matrix (RCM) & Process Flowcharts",
  ...
  "erm": {
    ...
    details: [
      ...
      "Risk reporting templates based on the ISO, COCO and COSO",
...
const sidebarLinks = [
  ...
  { id: "stock-audit", label: "Stock Audit & Verification" },
  { id: "internal-audit", label: "Internal Audit" },
  { id: "sop", label: "SOP Development" },
