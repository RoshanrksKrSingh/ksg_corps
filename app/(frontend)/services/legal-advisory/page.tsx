...
export default function LegalAdvisoryPage() {
  ...
  const services = [
    { id: "labour-law", title: "Labour Law Advisory" },
    { id: "corporate-law", title: "Corporate and Commercial Law" },
    { id: "litigation", title: "Litigation and Dispute Resolution" },
    { id: "aml", title: "Anti-Money Laundering (AML)" },
    { id: "esr", title: "Economic Substance Advisory" },
    { id: "ubo", title: "Ultimate Beneficial Owner (UBO)" },
  ];

  // Image for Overview Section (Legal/Corporate Theme)
  const overviewImage = "https://images.pexels.com/photos/5668473/pexels-photo-5668473.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-green-200">
                        Expert Guidance on Corporate Legal Affairs
                    </h2>
                    <div className="space-y-6 text-lg leading-relaxed text-gray-300">
                        <p>The growing complexity of the global regulatory environment encourages companies to find solutions and guidance on a broad range of issues arising from day-to-day operational activities for greater organization, specialization, and sectorial knowledge.</p>
                        <p>With a comprehensive understanding of Business and Corporate Commercial Laws, Employment Laws, Real Estate Regulations, Intellectual Property Rules and Regulations, UAE Civil and Criminal Laws and various other legal aspects in the Middle East, KSG Corporate Services can address all your legal issues and deliver effective Legal Advisory services for your specific requirements.</p>
                    </div>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#041D2D]">Explore Our Legal Services</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-green-500 mx-auto mt-4 rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
                <Link key={s.id} href={`/services/legal-advisory/${s.id}`} className="group relative p-8 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
