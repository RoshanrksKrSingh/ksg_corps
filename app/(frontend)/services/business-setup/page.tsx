              ...
              <div className="space-y-8">
                ...
                >
                  <p>
                    ...
                    at establishing a presence in the region. Depending on the
                    planned business activities, companies can choose from
                    onshore, free zone and offshore business structures. KSG
                    help to evaluate the feasibility of setting up a Mainland
                    UAE Branch / Mainland UAE LLC / FZ branch / FZ Company to
                    undertake the proposed activities. Registering the entity
                    and obtaining business licenses, as well as support you get
                    the necessary employment visas, work and residences permits
                    in the UAE. Our services cover the entire spectrum of
                    company formation procedures in the UAE. From company
                    registration and trade license acquisition to contract
                    drafting and notarization of documents, we guide you at
          ...
          <div className="w-[99%] max-w-8xl 2xl:max-w-[95%] mx-auto px-4 lg:px-8">
            ...
            >
              <h2 className="text-xl sm:text-2xl lg:text-[1.8rem] xl:text-3xl 2xl:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 transition-colors">
                Our Business Setup/Corporate PRO includes
              </h2>
            ...
            >
              {services.map((s) => (
                <motion.div key={s.id} variants={cardVariant}>
                  <Link
                    href={`/services/business-setup/${s.id}`}
