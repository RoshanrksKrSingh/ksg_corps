...
export default function DigitalDevelopmentPage() {
  ...
  // Image for Overview Section (Digital/Code Theme)
  const overviewImage = "https://images.pexels.com/photos/5474295/pexels-photo-5474295.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1";
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-green-200">
                        Accelerating Growth in the Digital Era
                    </h2>
                    <div className="space-y-6 text-lg leading-relaxed text-gray-300">
                        <p>In a world driven by connectivity, your digital footprint is your most powerful asset. At KSG, we blend creative design, cutting-edge technology, and data-driven strategies to build digital experiences that define brands and drive measurable growth. We don't just build platforms; we create ecosystems that engage customers and streamline operations.</p>
                        <p>From crafting high-performance websites and intuitive mobile applications to pioneering secure blockchain solutions and executing impactful digital marketing campaigns, our Digital & Development team is your partner in navigating the complexities of the modern digital landscape and staying ahead of the curve.</p>
                    </div>
                </div>
                ...
                <div className="relative group mt-12 lg:mt-24">
                    ...
                    <div className="relative rounded-3xl overflow-hidden">
                        <img 
                            src={overviewImage} 
                            alt="Digital & Development Overview" 
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#041D2D]">Explore Our Digital Solutions</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-green-500 mx-auto mt-4 rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((s) => (
                <Link key={s.id} href={`/services/digital-development/${s.id}`} className="group relative p-8 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
