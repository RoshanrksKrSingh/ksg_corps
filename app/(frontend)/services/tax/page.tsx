...
export default function TaxPage() {
  ...
  // Services List for Buttons (Tax Specific)
  const services = [
    {
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#09102d] min-h-screen font-sans transition-colors duration-300">
      ...
      <div className="relative overflow-hidden bg-slate-50 dark:bg-gradient-to-b dark:from-[#09102d] dark:to-[#0F333D] transition-colors duration-300">
        ...
        {/* --- SECTION 1: OVERVIEW --- */}
        <section className="relative z-10 w-full pt-10 pb-10">
          <div className="w-[99%] max-w-8xl 2xl:max-w-[95%] mx-auto px-4 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="space-y-8">
                ...
                >
                  <p>
                    Reducing the impact of complexity of tax related concerns
                    and forming your tax strategies align with your
                    organisational goals. We offer a full range of services to
                    address the International Tax, Transfer Pricing, Value Added
                    Tax (VAT) and Excise Tax challenges, which ensures that
                    organizations remain ahead of the requirements within and
                    outside the UAE, along with supporting the impact which may
                    occur across the wider GCC (KSAVAT, Bahrain VAT and Oman
                    VAT).
                  </p>
                </motion.div>
              </div>
