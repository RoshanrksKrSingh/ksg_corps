...
export default function CorporateAdvisoryPage() {
  ...
  const services = [
    { id: "strategy", title: "Business Strategic Formulation" },
    { id: "restructuring", title: "Organisational Restructuring" },
    { id: "expansion", title: "Business Expansion Advisory" },
    { id: "process-improvement", title: "Process Improvement" },
    { id: "feasibility", title: "Feasibility Studies" },
    { id: "cross-border", title: "Cross-Border Expansion" },
    { id: "bcp", title: "Business Continuity Planning (BCP)" },
  ];
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-green-200">
                        Formulating and achieving your strategic goals
                    </h2>
                    <div className="space-y-6 text-lg leading-relaxed text-gray-300">
                        <p>With rapidly evolving client needs in the GCC region, as trusted advisors for our client’s corporate affairs, we at KSG Corporate Services assist our clients in formulating and achieving their strategic goals by offering corporate advisory services that can help to transform their financial and operational functions.</p>
                        <p>Our multidisciplinary approach to customer experience innovation gives you a 360-degree view of how to better create and deliver the right differentiating experiences to the right customers at the right time.</p>
                    </div>
                </div>

                {/* Image Section - Shifted Down, Zoom Effect, No Shadow */}
                <div className="relative group mt-12 lg:mt-24">
                    ...
                    <div className="relative rounded-3xl overflow-hidden">
                        <img 
                            ...
                            alt="Corporate Advisory Overview" 
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20">
        <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#041D2D]">Explore Our Advisory Services</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-orange-500 to-green-500 mx-auto mt-4 rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
                <Link key={s.id} href={`/services/corporate-advisory/${s.id}`} className="group relative p-8 bg-white border border-gray-200 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
