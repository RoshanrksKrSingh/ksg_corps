          ...
          <div className="w-[99%] max-w-8xl 2xl:max-w-[95%] mx-auto px-4 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="space-y-8">
                ...
                >
                  <p>
                    Audit and Accounting services help organisation in aligning
                    their financial and accounting processes and making informed
                    business decisions. This empowers them to have better
                    control and visibility of their finance organization and
                    achieve better business outcomes. An audit lends credibility
                    to our clients’ financial statements while complete
                    accounting provides fair financial position of the
                    Organisation.
                  </p>
                  <p>
                    Commercial Companies Law and Value Added Tax (VAT) have laid
                    down clear rules about the maintenance of business accounts
                    and financial details and compliance with International
                    Financial Reporting Standards (IFRS). We at KSG committed to
                    deliver an innovative solution that helps maximize
                    performance in business transactions processing, billing,
                    collections, accounting of business transactions and
                    preparation of financial statements and other areas critical
                    to elevate the role of the finance function in their
                    organization.
                  </p>
                </motion.div>
              </div>
              ...
              >
                <div className="relative w-full max-w-md lg:max-w-full">
                  <div className="rounded-tl-[30px] rounded-br-[30px] overflow-hidden shadow-2xl border border-gray-200 dark:border-white/10">
                    <img
                      src="https://images.pexels.com/photos/6248988/pexels-photo-6248988.jpeg"
                      alt="Accounting Overview"
